...
export type AdminRightsRenounced = ContractEventLog<{}>;
...
export type FuseAdminRightsRenounced = ContractEventLog<{}>;
...
export type NewAdminFee = ContractEventLog<{
  oldAdminFeeMantissa: string;
  newAdminFeeMantissa: string;
  0: string;
  1: string;
}>;
...
export type NewFuseFee = ContractEventLog<{
  oldFuseFeeMantissa: string;
  newFuseFeeMantissa: string;
  0: string;
  1: string;
}>;
...
export interface CToken extends BaseContract {
  ...
  methods: {
    ...
    _renounceAdminRights(): NonPayableTransactionObject<string>;

    _renounceFuseAdminRights(): NonPayableTransactionObject<string>;
    ...
    _setFuseFee(): NonPayableTransactionObject<string>;
    ...
    adminFeeMantissa(): NonPayableTransactionObject<string>;
    ...
    fuseFeeMantissa(): NonPayableTransactionObject<string>;
    ...
    "initialize(address,address,uint256,string,string,uint8,uint256,uint256)"(
      ...
      reserveFactorMantissa_: number | string | BN,
      adminFeeMantissa_: number | string | BN
    ...
    isCEther(): NonPayableTransactionObject<boolean>;
  ...
  events: {
    ...
    AdminRightsRenounced(cb?: Callback<AdminRightsRenounced>): EventEmitter;
    AdminRightsRenounced(
      options?: EventOptions,
      cb?: Callback<AdminRightsRenounced>
    ): EventEmitter;
    ...
    FuseAdminRightsRenounced(
      cb?: Callback<FuseAdminRightsRenounced>
    ): EventEmitter;
    FuseAdminRightsRenounced(
      options?: EventOptions,
      cb?: Callback<FuseAdminRightsRenounced>
    ...
    NewFuseFee(cb?: Callback<NewFuseFee>): EventEmitter;
    NewFuseFee(options?: EventOptions, cb?: Callback<NewFuseFee>): EventEmitter;
  ...
  once(event: "AdminRightsRenounced", cb: Callback<AdminRightsRenounced>): void;
  once(
  ...
  once(event: "NewFuseFee", cb: Callback<NewFuseFee>): void;
  once(
    event: "NewFuseFee",
    options: EventOptions,
    cb: Callback<NewFuseFee>
  ): void;
