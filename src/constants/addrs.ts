export default {
  137: {
    ...
    blocksPerMin: 60 / 2, // 1 block per 2s
    bytecodeHashes: {
      oracle: {
  ...
  250: {
    ...
    blocksPerMin: 60 / 1.2, //  1 block per 1.2s
    bytecodeHashes: {
      oracle: {},
      irm: {
        JumpRateModel:
  ...
  43114: {
    ...
    ownedAccounts: ["0x4237012403135F3f255d9F92065E7560739A7348"],
  },
  1285: {
    poolDirectory:
    ...
    blocksPerMin: Math.ceil(60 / 23.4), // 1 block per 23.4s
    bytecodeHashes: {
      oracle: {},
      irm: {
        JumpRateModel:
    ...
    ownedAccounts: ["0x79157e9fE9A9546FDe1C643dA226dE64aB6322CB"],
  },
};
